<div class="container bg-body rounded-bottom-5 d-flex mb-5 py-3">
    ...
    <div class="my-auto mx-auto d-flex gap-3">
        <a href="#" class="fs-5 text-decoration-none fw-bold active">Browse</a>
        <a href="#" class="fs-5 text-decoration-none fw-bold text-secondary">Become an Owner</a>
    </div>
    <div class="d-flex me-5 align-items-center gap-3">
        ...
        <!-- no acc -->
        <button type="button" class="success btn btn-outline-success rounded-pill py-2 gradient-success">Rent Now</button>
        
        <!-- IF LOGGED IN  -->
        <!-- <button type="button" class="success btn btn-outline-success rounded-circle m-0 p-0">
