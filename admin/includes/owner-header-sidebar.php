...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/rb/admin/analytics.php"><i class="fas fa-chart-bar me-2"></i> Reports and Analytics</a>
        <a href="/rb/admin/respond_support.php"><i class="fas fa-chart-bar me-2"></i> Respond Supports</a>
        <a href="/rb/admin/supports.php"><i class="fas fa-chart-bar me-2"></i> Support</a>
