...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $conn->prepare("UPDATE support_requests SET admin_response = :admin_response, status = 'closed' WHERE id = :support_id");
...
$stmt = $conn->prepare("SELECT sr.*, u.name AS user_name 
